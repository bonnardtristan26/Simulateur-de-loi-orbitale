...
CorpsCelesteTest = np.array([
    [1.989e30, 0.0, 0.0, 0.0, 0.0, 1.39e4],
    [3.285e23, 6.98e7, 0.0, 0.0, 4.8e4, 4.8e2],
    [4.867e24, 1.089e8, 0.0, 0.0, 3.5e4, 1.21e2],
    [5.972e24, 1.521e8, 0.0, 0.0, 2.978e4, 1.27e2],
    [6.39e23, 2.492e8, 0.0, 0.0, 2.41e4, 6.7e2],
    [1.898e27, 8.166e8, 0.0, 0.0, 1.3e4, 1.42e3],
    [5.683e26, 1.514e9, 0.0, 0.0, 9.7e3, 1.16e3],
    [8.681e25, 3.003e9, 0.0, 0.0, 6.8e3, 5.11e2],
    [1.024e26, 4.545e9, 0.0, 0.0, 5.4e3, 49.5e2]
], dtype=float)
